...
import { addCustomizableItem, addItemToCart } from '@state/reducers/CartSlice';
              ...
              <View style={styles.subContainer} key={index}>
                ...
                <DottedLine />
                {
                  customization?.options?.map((option: any, i: number) => {
                    return (
                      <TouchableOpacity key={i} style={styles.optionContainer} onPress={() => { selectedOptionHandler(customization?.type, i) }}>
